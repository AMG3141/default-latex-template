...
\usepackage[a4paper, margin=2cm, headheight=10mm]{geometry}
...
% Title and date
\title{\Huge{\MakeUppercase{\modulecode\ \modulename}: \MakeUppercase{\documenttitle}}\\\LARGE\MakeUppercase{\documentsubtitle}}
